...
public class Assert extends org.springframework.util.Assert {
    ...
    {
      throw new BaseException("styzf.system.error");
    }
    ...
    public static void throwException(String errorKey) {
      throw new BaseException(errorKey, getLocaleMsg(errorKey, null));
    }
    
    public static void throwException(String errorKey, Throwable cause) {
      throw new BaseException(errorKey, getLocaleMsg(errorKey, null), cause);
    }
    
    public static void throwException(String errorKey, Object[] params) {
      throw new BaseException(errorKey, getLocaleMsg(errorKey, params));
    }

    public static void throwException(String errorKey, String errorMsg) {
        throw new BaseException(errorKey, errorMsg);
    }

    public static void throwException(String errorKey, String errorMsg, Object[] params) {
        throw new BaseException(errorKey, MessageFormat.format(errorMsg, params));
    }
    
    public static void throwException(String errorKey, Object[] params, Throwable cause) {
      throw new BaseException(errorKey, getLocaleMsg(errorKey, params), cause);
    }
    
    public static void isTrue(boolean expression, String message) {
      if (!expression)
        throw new BaseException(message, getLocaleMsg(message, null));
    }
    
    public static void isTrue(boolean expression, String message, Object[] params) {
      if (!expression)
        throw new BaseException(message, getLocaleMsg(message, params));
    }
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
      ...
      throw new BaseException(errorMessage, errorMessage);
    }
