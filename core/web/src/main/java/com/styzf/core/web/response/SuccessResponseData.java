...
public class SuccessResponseData extends Response {
    ...
    private SuccessResponseData(Object data) {
      super(Boolean.TRUE);
      this.data = data;
    }
    
    private SuccessResponseData(Object data, Map<String, Format> convertMap, Map<String, Boolean> authorityMap) {
      super(Boolean.TRUE);
      this.data = data;
    ...
    private SuccessResponseData(Object data, Map<String, Format> convertMap) {
      super(Boolean.TRUE);
      this.data = data;
      this.convertMap = convertMap;
    }
